...
import com.user.management.dto.ErrorDetails;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorDetails> duplicatePropertyExceptionHandler(Exception exception, WebRequest webRequest) {
        ErrorDetails errorDetails = new ErrorDetails(new Date(), exception.getMessage(), webRequest.getDescription(false));
